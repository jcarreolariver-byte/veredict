...
|---|---------|-----------|--------|
| 1 | `docs/PRD.md` | Qué construimos, para quién, métricas de éxito, scope MVP | ✅ aprobado |
| 2 | `docs/UX.md` | Pantallas, flujos, happy path, estados vacíos y error | ✅ aprobado |
| 3 | `docs/SCHEMA.md` | Tablas Supabase, RLS policies, índices, edge cases | ✅ aprobado |
| 4 | `docs/ARCH.md` | Stack, estructura de carpetas, patrones, naming conventions | ✅ aprobado |
| 5 | `docs/ROADMAP.md` | Fases del build, entregables por fase, criterio de "done" | ✅ aprobado |
